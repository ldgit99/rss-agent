...
sample: 19명
context: 영어 교육
theoretical_framework: TPACK, 자기조절 학습(SRL)
...
# Summary
본 연구는 생성적 인공지능(GenAI) 도구의 급속한 발전이 예비 교사들에게 기술적 교수 내용 지식(TPACK)과 자기조절 학습(SRL) 전략 개발의 필요성을 강조하고 있음을 보여준다. 기존의 교사 교육 프로그램은 AI 문해력과 교수 적응 기술을 갖출 수 있도록 체계적인 접근이 부족하다. 이 질적 사례 연구는 마이크로러닝 모듈을 활용하여 예비 교사들의 TPACK과 SRL을 향상시키는 방법을 조사하였다. 13주 동안 19명의 참가자가 GenAI 중심의 마이크로러닝 모듈에 참여하여 AI 도구를 적응시키는 능력을 발전시켰다. 주제 분석 결과, 마이크로러닝이 GenAI 역량 개발에 구조적이고 낮은 인지 부담의 접근을 제공하며, 참가자들이 AI를 수업 계획에 활용하는 데 자신감과 자율성을 얻었고, 목표 설정 및 반복적 개선과 같은 SRL 전략이 AI 통합에 필수적임을 발견하였다.

# Research Logic
## Problem
기존 교사 교육 프로그램의 AI 문해력 및 교수 적응 기술 부족.
## Theory
TPACK 및 자기조절 학습(SRL) 이론.
## Design
마이크로러닝 모듈을 통한 질적 사례 연구 설계.
## Findings
1. 마이크로러닝이 GenAI 역량 개발에 효과적임.
2. 참가자들이 AI 활용에 대한 자신감과 자율성을 얻음.
3. SRL 전략이 AI 통합에 필수적임.
## Conclusion
마이크로러닝은 AI 문해력과 교수적 AI 응용을 연결하는 잠재력을 지니며, 교사 교육을 위한 확장 가능한 모델을 제공함.

# Key Findings
- 마이크로러닝은 구조적이고 낮은 인지 부담의 접근을 제공함.
- 참가자들은 AI 도구를 활용하는 데 자신감을 얻음.
- SRL 전략이 AI 통합에 필수적임.

# Contributions
## Theoretical
TPACK 및 SRL 이론의 적용을 통한 새로운 통찰 제공.
## Methodological
질적 사례 연구를 통한 마이크로러닝의 효과 분석.
## Practical
예비 교사를 위한 AI 통합 교육 모델 제안.
...
- 마이크로러닝이 AI 문해력 향상에 기여할 수 있음.
- SRL 전략이 다양한 교육 환경에서 유용할 수 있음.

# Idea Seeds
1. 마이크로러닝 모듈의 다양한 주제 개발.
2. AI 도구 활용에 대한 추가 연구.
3. SRL 전략을 포함한 교육 프로그램 설계.
...
요약: 본 연구는 예비 교사 교육에서 생성적 인공지능 도구의 활용을 위한 마이크로러닝 모듈의 효과를 조사하였다. 참가자들은 AI 문해력과 교수 적응 기술을 발전시키며, SRL 전략이 AI 통합에 필수적임을 발견하였다. 마이크로러닝은 AI 교육의 확장 가능한 모델로 제안된다.
