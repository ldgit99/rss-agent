...
- DOI: 명시되지 않음
- Published: 명시되지 않음
- Authors: Lucas Kohnke, Di Zou, Haoran Xie
- Categories: ERIC
...
research_type: 질적 연구
methodology: 사례 연구
data_type: 반사 저널, 반구조화 인터뷰
sample: 19명
context: 영어 교육
theoretical_framework: TPACK, 자기 조절 학습(SRL)
...
# Summary
본 연구는 생성적 인공지능(GenAI) 도구의 급속한 발전이 예비 교사들에게 기술적 교수 콘텐츠 지식(TPACK) 및 자기 조절 학습(SRL) 전략 개발의 필요성을 강조하고 있음을 보여준다. 기존의 교사 교육 프로그램은 AI 문해력 및 교수 적응 기술을 갖추기 위한 체계적인 접근 방식이 부족하다. 이 질적 사례 연구는 마이크로러닝 모듈을 활용하여 예비 교사들의 TPACK 및 SRL을 향상시키는 방법을 조사하였다. 13주 동안 19명의 참가자가 GenAI 중심의 마이크로러닝 모듈에 참여하여 AI 도구를 적응시키는 능력을 발전시켰다. 주제 분석 결과, 마이크로러닝이 GenAI 역량 개발에 구조적이고 낮은 인지 부담의 접근 방식을 제공했으며, 참가자들이 AI를 활용한 수업 계획에 대한 자신감과 자율성을 얻었고, SRL 전략이 AI 통합에 필수적임을 발견하였다.

# Research Logic
## Problem
기존 교사 교육 프로그램의 AI 문해력 및 교수 적응 기술 부족.
## Theory
TPACK 및 자기 조절 학습(SRL) 이론을 기반으로 한 연구.
## Design
질적 사례 연구 디자인, 마이크로러닝 모듈 적용.
## Findings
1. 마이크로러닝이 GenAI 역량 개발에 효과적임.
2. 참가자들이 AI 활용에 대한 자신감과 자율성을 얻음.
3. SRL 전략이 AI 통합에 필수적임.
## Conclusion
마이크로러닝은 AI 문해력과 교수적 AI 응용을 연결하는 잠재력을 지닌 모델임.

# Key Findings
- 마이크로러닝은 구조적이고 낮은 인지 부담의 접근 방식을 제공함.
- 참가자들은 AI를 활용한 수업 계획에서 자신감과 자율성을 얻음.
- SRL 전략이 AI 통합에 필수적임.

# Contributions
## Theoretical
TPACK 및 SRL 이론의 적용을 통해 AI 교육의 필요성을 강조.
## Methodological
질적 사례 연구를 통해 마이크로러닝의 효과를 실증적으로 분석.
## Practical
예비 교사 교육을 위한 AI 통합 모델 제안.

# Limitations
- 연구 기간이 짧아 장기적 효과를 평가하기 어려움.
- 참가자 수가 적어 일반화에 한계가 있음.

# Transferable Insights
- 마이크로러닝이 AI 문해력 개발에 효과적일 수 있음.
- SRL 전략이 다양한 교육 환경에서 유용할 수 있음.

# Idea Seeds
1. 마이크로러닝 모듈을 다른 과목에 적용한 연구.
2. AI 도구의 한계 극복을 위한 추가 교육 프로그램 개발.
3. SRL 전략을 통합한 교사 교육 커리큘럼 설계.

# Citation Snippets
> Kohnke, L., Zou, D., & Xie, H. (명시되지 않음). Microlearning and Generative AI for Pre-Service Teacher Education: A Qualitative Case Study.
...
요약: 본 연구는 생성적 인공지능 도구의 발전이 예비 교사들에게 TPACK 및 SRL 전략 개발의 필요성을 강조하고 있음을 보여준다. 마이크로러닝 모듈을 통해 예비 교사들이 AI 도구를 효과적으로 활용할 수 있는 방법을 제시하며, AI 문해력과 교수적 응용의 연결 가능성을 탐구하였다.
