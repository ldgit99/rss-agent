...
- DOI: 명시되지 않음
- Published: 명시되지 않음
- Authors: Davy Tsz Kit Ng, Chen Xinyu, Jac Ka Lok Leung, Samuel Kai Wah Chu
- Categories: ERIC
...
journal: ERIC
doi: 명시되지 않음
research_type: 준실험 연구
methodology: 준실험적 접근 및 포커스 그룹 인터뷰
data_type: 양적 및 질적 데이터
sample: 명시되지 않음
context: AI 리터러시 교육을 위한 게임 기반 접근법
...
# Summary
본 연구는 TreasureIsland라는 온라인 플랫폼을 개발하여 게임화된 전자책을 통해 학생들의 AI 리터러시를 향상시키는 방법을 조사하였다. 준실험 연구를 통해 게임 기반 접근법이 학생들의 동기, 자기 효능감, 진로 관심 및 AI 개념 이해를 개선하는 데 효과적임을 발견하였다. 그러나 AI 사용에 대한 자신감 및 AI를 적용, 평가, 창작하는 고차원적 인지 능력은 향상되지 않았다. 연구 결과는 게임 메커니즘을 통한 경쟁적 학습 환경 조성, 스캐폴딩 모듈 및 피드백 제공, 복잡한 AI 개념의 시각화를 통한 AI 리터러시 증진 가능성을 제시하였다. 향후 연구에서는 flipped classroom 및 프로젝트 기반 학습과 같은 교육적 요소를 추가할 것을 제안하였다.

# Research Logic
## Problem
AI 리터러시 교육에서 초보 학습자에 대한 효과적인 스캐폴딩과 동기 지원의 필요성.
## Theory
게임 기반 접근법이 AI 리터러시와 동기 부여에 미치는 영향.
## Design
준실험적 연구 디자인과 포커스 그룹 인터뷰를 통한 데이터 수집.
## Findings
TreasureIsland 플랫폼 사용이 학생들의 동기, 자기 효능감, 진로 관심 및 AI 개념 이해를 향상시켰으나, AI 사용 자신감 및 고차원적 인지 능력은 향상되지 않음.
## Conclusion
게임화된 접근법이 학습자의 AI 리터러시를 촉진할 수 있는 정서적 및 인지적 지원을 제공함.

# Key Findings
- TreasureIsland 플랫폼이 학생들의 동기와 자기 효능감을 향상시킴.
- AI 개념과 윤리에 대한 이해가 개선됨.
- 고차원적 AI 적용, 평가 및 창작 능력은 향상되지 않음.

# Contributions
## Theoretical
AI 리터러시 교육에 대한 경험적 및 이론적 기초 제공.
## Methodological
준실험적 연구 디자인과 포커스 그룹 인터뷰를 통한 데이터 수집 방법론 제시.
## Practical
게임화된 플랫폼을 통한 교육적 지식 확장 및 AI 리터러시 증진 방안 제안.

# Limitations
- 샘플 크기 및 특성이 명시되지 않음.
- 연구 기간 및 환경에 대한 정보 부족.

# Transferable Insights
- 게임 기반 학습이 AI 리터러시 교육에 효과적일 수 있음.
- 스캐폴딩과 피드백이 학습 효과를 증진하는 데 중요함.

# Idea Seeds
1. AI 리터러시 교육을 위한 다양한 게임화 요소 개발.
2. flipped classroom과 프로젝트 기반 학습 통합 방안 연구.
3. AI 개념의 시각화를 위한 새로운 교육 도구 개발.
...
요약: 본 연구는 TreasureIsland 플랫폼을 통해 학생들의 AI 리터러시를 향상시키는 방법을 조사하였다. 게임 기반 접근법이 동기와 자기 효능감을 개선하였으나, AI 사용 자신감 및 고차원적 인지 능력은 향상되지 않았다. 향후 연구에서는 flipped classroom 및 프로젝트 기반 학습을 추가할 것을 제안하였다.
