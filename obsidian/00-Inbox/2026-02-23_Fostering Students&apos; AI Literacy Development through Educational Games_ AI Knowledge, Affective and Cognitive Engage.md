...
methodology: 준실험적 접근, 포커스 그룹 인터뷰
...
# Summary
본 연구는 TreasureIsland라는 온라인 플랫폼을 통해 게임화된 전자책을 활용하여 학생들의 AI 리터러시를 향상시키는 방법을 조사하였다. 준실험적 접근을 통해 게임 기반 접근법이 학생들의 동기, 자기 효능감, 진로 관심 및 AI 개념 이해를 개선하는 데 효과적임을 발견하였다. 그러나 AI 사용에 대한 자신감 및 AI를 적용, 평가, 창작하는 고차원적 인지 능력은 향상되지 않았다. 인터뷰 결과, 게임 메커니즘을 통한 경쟁적이고 동기 부여가 되는 학습 환경 조성, 스캐폴딩 모듈 및 피드백 제공, 복잡한 AI 개념의 시각화가 AI 리터러시 증진에 기여할 수 있음을 나타냈다. 향후 연구에서는 flipped classroom 및 프로젝트 기반 학습과 같은 교수법 요소를 추가할 것을 제안하였다.

# Research Logic
## Problem
AI 리터러시 교육을 위한 효과적인 스캐폴딩 및 지원의 필요성.
## Theory
게임 기반 접근법이 학생들의 AI 리터러시와 학습 동기를 증진할 수 있다는 연구 증거.
## Design
TreasureIsland 플랫폼을 활용한 준실험적 연구 설계.
## Findings
학생들의 동기, 자기 효능감, 진로 관심 및 AI 개념 이해가 향상되었으나, AI 사용 자신감 및 고차원적 인지 능력은 향상되지 않음.
## Conclusion
게임화는 학습자의 AI 리터러시를 증진하는 데 효과적이며, 교수 설계자와 교사에게 유용한 pedagogical 지식을 제공함.

# Key Findings
- TreasureIsland 플랫폼이 학생들의 동기와 자기 효능감을 향상시킴.
- AI 개념과 윤리에 대한 이해가 개선됨.
- AI 적용, 평가 및 창작 능력은 향상되지 않음.

# Contributions
## Theoretical
AI 리터러시 교육에 대한 경험적 및 이론적 기초 제공.
## Methodological
준실험적 접근과 포커스 그룹 인터뷰를 통한 데이터 수집 방법론 제시.
## Practical
게임화된 플랫폼을 통한 교수 설계의 개선 방안 제안.

# Limitations
- 샘플 크기 및 구성에 대한 정보 부족.
- 연구 기간 및 환경의 제한.

# Transferable Insights
- 게임화된 접근법이 다양한 교육 환경에서 적용 가능함.
- AI 리터러시 교육을 위한 교수법 개발에 기여할 수 있음.

# Idea Seeds
1. 게임화된 학습 환경에서의 AI 리터러시 교육 효과 연구.
2. flipped classroom과 프로젝트 기반 학습의 통합 방안 탐색.
3. 다양한 학습자 특성에 따른 AI 리터러시 교육의 맞춤형 접근법 개발.

# Citation Snippets
>

tags: #human-ai collaboration, #classroom ai, #ai tutoring, #instructional design, #scaffolding, #ai literacy, #ai pedagogy
